#-*- coding:utf-8 –*-
#
import vtk                                    	    # 导入vtk库，字母均为小写 手动阀 手动阀
...
actor.SetMapper(mapper)                         	# 设置actor数据源
actor.GetProperty().SetColor(0.7, 0.7, 0.7)         # 设置actor显示颜色
...
window.SetSize(900, 900)                         	# 设置窗口尺寸，单位为像素
